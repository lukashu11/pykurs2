Project Name:   Cancellation Prevention

Motivation:     This project aims to predict order cancellations within the brazilian Olist eCommerce dataset.
                ...
                cost savings (e.g. due to less customer service efforts) and increased customer satisfaction and retention (e.g. due to less problems occuring in the ordering process).
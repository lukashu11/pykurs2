...
# churn = join_dfs(churn, count_order_items, join_key=['order_id'],drop_nan=['order_id'])
avg_price = calc_mean(olist_order_items[['order_id', 'price']], groupkey=['order_id'], dict={'price': 'avg_price'})

from functools import reduce

df_to_merge = [churn, count_order_items, avg_price]
...
churn = churn.set_index('order_id').dropna()
...
churn = churn.drop(columns=['order_purchase_timestamp', 'customer_id', 'customer_city']).drop_duplicates()
